...
DEFINE VARIABLE sld-1 AS INTEGER INITIAL 0 
     VIEW-AS SLIDER MIN-VALUE 0 MAX-VALUE 40 HORIZONTAL 
     TIC-MARKS NONE 
...
DEFINE FRAME fMain
     sld-1 AT ROW 3.38 COL 3 NO-LABEL WIDGET-ID 42
     btn-1 AT ROW 5.76 COL 2 WIDGET-ID 50
     slc-1 AT ROW 6.95 COL 2 NO-LABEL WIDGET-ID 48
     "Quantas Operações?" VIEW-AS TEXT
          SIZE 21 BY .62 AT ROW 2.19 COL 57 WIDGET-ID 44
     "fibo.w [v1.00]" VIEW-AS TEXT
     ...
     RECT-47 AT ROW 3.14 COL 2 WIDGET-ID 52
...
------------------------------------------------------------------------------*/
    DO WITH FRAME {&FRAME-NAME}:
        DEF INPUT PARAMETER xa      AS INT NO-UNDO.
        DEF INPUT PARAMETER xb      AS INT NO-UNDO.
        DEF INPUT PARAMETER xc      AS INT NO-UNDO.
        DEF INPUT PARAMETER xe      AS CHAR NO-UNDO.

        DEF VAR xd      AS INT NO-UNDO.
        ...
        IF xx < INT(sld-1:SCREEN-VALUE) - 2 THEN
            RUN Fibo(xb, xd, INT(xx + 1), texto).
        ELSE RETURN.
