...
DEFINE FRAME fMain
     fll3 AT ROW 3.86 COL 66 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     fll1 AT ROW 5.76 COL 2 NO-LABEL WIDGET-ID 2
     btn1 AT ROW 6.95 COL 64 WIDGET-ID 10
     fll2 AT ROW 8.62 COL 2 NO-LABEL WIDGET-ID 4
     btn2 AT ROW 9.81 COL 64 WIDGET-ID 12
     "Key:" VIEW-AS TEXT
          SIZE 8 BY .62 AT ROW 3.14 COL 68 WIDGET-ID 42
     "caesar.w [v1.00]" VIEW-AS TEXT
          SIZE 39 BY .71 AT ROW 11.24 COL 2 WIDGET-ID 40
          FONT 13
     "Cifra de César" VIEW-AS TEXT
          SIZE 38 BY 1.91 AT ROW 1.24 COL 2 WIDGET-ID 36
     "Texto para Encriptar:" VIEW-AS TEXT
          SIZE 21 BY .62 AT ROW 5.05 COL 2 WIDGET-ID 6
     "Texto para Desencriptar:" VIEW-AS TEXT
          SIZE 25 BY .62 AT ROW 7.91 COL 2 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 80 BY 11.33 WIDGET-ID 100.
...
DO:
    DO WITH FRAME {&FRAME-NAME}:
        ...
        DEF VAR tamanhoTexto AS INT NO-UNDO.

        /* Faz a leitura dos valores na tela */
        texto = STRING(fll1:SCREEN-VALUE).
        ...
        REPEAT xx = 1 TO LENGTH(texto):
            textoEncriptado = textoEncriptado + CHR(ASC(SUBSTRING(texto, xx, 1)) 
                                                 + chave).
        END.

        /* Define o resultado */
        fll2:SCREEN-VALUE = textoEncriptado.
...
DO:
    DO WITH FRAME {&FRAME-NAME}:
        ...
        /* Faz a leitura dos valores na tela */
        texto = STRING(fll2:SCREEN-VALUE).
        chave = INT(fll3:SCREEN-VALUE).
